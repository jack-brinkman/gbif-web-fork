...
function reduce(item) {
  ...
  const verbatim = source.verbatim && removeUndefined({
    ...
    earliestAgeOrLowestStage:           source.verbatim.core['http://rs.tdwg.org/dwc/terms/earliestAgeOrLowestStage'],
    earliestEonOrLowestEonothem:        source.verbatim.core['http://rs.tdwg.org/dwc/terms/earliestEonOrLowestEonothem'],
    earliestEpochOrLowestSeries:        source.verbatim.core['http://rs.tdwg.org/dwc/terms/earliestEpochOrLowestSeries'],
    earliestEraOrLowestErathem:         source.verbatim.core['http://rs.tdwg.org/dwc/terms/earliestEraOrLowestErathem'],
    earliestPeriodOrLowestSystem:       source.verbatim.core['http://rs.tdwg.org/dwc/terms/earliestPeriodOrLowestSystem'],
    ...
    georeferenceVerificationStatus:     source.verbatim.core['http://rs.tdwg.org/dwc/terms/georeferenceVerificationStatus'],
    ...
    identificationQualifier:            source.verbatim.core['http://rs.tdwg.org/dwc/terms/identificationQualifier'],
    ...
    latestAgeOrHighestStage:            source.verbatim.core['http://rs.tdwg.org/dwc/terms/latestAgeOrHighestStage'],
    latestEonOrHighestEonothem:         source.verbatim.core['http://rs.tdwg.org/dwc/terms/latestEonOrHighestEonothem'],
    latestEpochOrHighestSeries:         source.verbatim.core['http://rs.tdwg.org/dwc/terms/latestEpochOrHighestSeries'],
    latestEraOrHighestErathem:          source.verbatim.core['http://rs.tdwg.org/dwc/terms/latestEraOrHighestErathem'],
    latestPeriodOrHighestSystem:        source.verbatim.core['http://rs.tdwg.org/dwc/terms/latestPeriodOrHighestSystem'],
    lithostratigraphicTerms:            source.verbatim.core['http://rs.tdwg.org/dwc/terms/lithostratigraphicTerms'],
    ...
    lowestBiostratigraphicZone:         source.verbatim.core['http://rs.tdwg.org/dwc/terms/lowestBiostratigraphicZone'],
    ...
    reproductiveCondition:              source.verbatim.core['http://rs.tdwg.org/dwc/terms/reproductiveCondition'],
    ...
    scientificNameAuthorship:           source.verbatim.core['http://rs.tdwg.org/dwc/terms/scientificNameAuthorship'],
    ...
    verbatimCoordinateSystem:           source.verbatim.core['http://rs.tdwg.org/dwc/terms/verbatimCoordinateSystem'],
