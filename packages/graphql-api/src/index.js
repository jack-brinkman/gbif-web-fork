...
async function initializeServer() {
  ...
  const server = new ApolloServer({
    ...
    resolvers,
    dataSources: () =>
      Object.keys(api).reduce((a, b) => ((a[b] = new api[b](config)), a), {}), // Every request should have its own instance, see https://github.com/apollographql/apollo-server/issues/1562
